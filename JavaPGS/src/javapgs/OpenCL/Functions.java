...
public class Functions {
    ...
    public static void test_quad(int notable, int notable_dist, int p0m, int p0n, int p1m, int p1n, int p2m, int p2n) {
        int p0r = p0n - p0m;
        int p1r = p1n - p1m;
        int p2r = p2n - p2m;
...
// Create kernel and set arguments
        CLKernel kernel = program.createKernel("test", prefs_buff, prime_buff, inp_p0, inp_p1, inp_p2);
