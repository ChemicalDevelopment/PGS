...
static PyObject *const_str_digest_9a2e3bdad39c325613307382ee4e466f;
...
{
    const_str_digest_9a2e3bdad39c325613307382ee4e466f = UNSTREAM_STRING( &constant_bin[ 279792 ], 55, 0 );
...
static PyCodeObject *codeobj_6c17407daa22b754294df4ff2cb49f2f;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_9a2e3bdad39c325613307382ee4e466f;
    codeobj_6c17407daa22b754294df4ff2cb49f2f = MAKE_CODEOBJ( module_filename_obj, const_str_plain_entities, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_ABSOLUTE_IMPORT );
}
...
MOD_INIT_DECL( html$entities )
{
    ...
    moduledict_html$entities = (PyDictObject *)((PyModuleObject *)module_html$entities)->md_dict;
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    PyObject *module_dict = PyModule_GetDict( module_html$entities );
    ...
    tmp_assign_source_2 = const_str_digest_9a2e3bdad39c325613307382ee4e466f;
    ...
    UPDATE_STRING_DICT0( moduledict_html$entities, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_3 );
    // Frame without reuse.
    frame_module = MAKE_MODULE_FRAME( codeobj_6c17407daa22b754294df4ff2cb49f2f, module_html$entities );
    ...
    // Framed code:
    tmp_import_globals_1 = ((PyModuleObject *)module_html$entities)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_html$entities, (Nuitka_StringObject *)const_str_plain_PY3, tmp_assign_source_4 );
    tmp_cond_value_1 = GET_STRING_DICT_VALUE( moduledict_html$entities, (Nuitka_StringObject *)const_str_plain_PY3 );
    ...
    branch_yes_1:;
    tmp_import_globals_2 = ((PyModuleObject *)module_html$entities)->md_dict;
    ...
    tmp_result = IMPORT_MODULE_STAR( module_html$entities, true, tmp_star_imported_1 );
    ...
    goto branch_end_1;
    branch_no_1:;
    tmp_import_globals_3 = ((PyModuleObject *)module_html$entities)->md_dict;
    frame_module->f_lineno = 7;
    tmp_star_imported_2 = IMPORT_MODULE( const_str_digest_8ed3d422e2abd169ea3504990d5a3467, tmp_import_globals_3, tmp_import_globals_3, const_tuple_str_chr_42_tuple, const_int_0 );
    ...
    tmp_result = IMPORT_MODULE_STAR( module_html$entities, true, tmp_star_imported_2 );
